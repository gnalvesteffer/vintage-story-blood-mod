...
public class EntityBleedBehavior
{
    ...
    private void Bleed()
    {
        ...
        particles.AddVelocity = new Vec3f(1, 1, 1) * (float)XorberaxBloodModSystem.Random.NextDouble() * 1.5f -
                                new Vec3f(1, 1, 1) * (float)XorberaxBloodModSystem.Random.NextDouble() * 1.5f;
